(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("contrive", [], factory);
	else if(typeof exports === 'object')
		exports["contrive"] = factory();
	else
		root["contrive"] = factory();
})(this, function() {
...
var Contrived = function () {
    function Contrived(payload) {
        _classCallCheck(this, Contrived);

        this.payload = payload;
    }

    _createClass(Contrived, [{
        key: 'transform',
        value: function transform(t, args) {
...
var ContrivedSet = __webpack_require__(50);
var Contrived = __webpack_require__(48);
...
var cloneDeep = __webpack_require__(51);
var merge = __webpack_require__(45);
var Contrived = __webpack_require__(48);

var ContrivedSet = function () {
    function ContrivedSet(base) {
        _classCallCheck(this, ContrivedSet);

        this.contrived = [new Contrived(base)];
    }

    _createClass(ContrivedSet, [{
        key: 'times',
        value: function times(n) {
            ...
            var peek = this.contrived[this.contrived.length - 1];

            this.contrived = this.contrived.concat(new Array(n - 1).fill(cloneDeep(peek)));

            return this;
        }
    }, {
        key: 'with',
        value: function _with(transform) {
            var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

            this.contrived.forEach(function (c, i) {
                var clonedArgs = cloneDeep(args);
                clonedArgs.i = i;
        ...
        key: 'valueOf',
        value: function valueOf() {
            var payloads = this.contrived.map(function (contrived) {
                return contrived.valueOf();
            });
...
var cloneArrayBuffer = __webpack_require__(24),
    ...
    cloneTypedArray = __webpack_require__(43);
...
//# sourceMappingURL=contrive.js.map